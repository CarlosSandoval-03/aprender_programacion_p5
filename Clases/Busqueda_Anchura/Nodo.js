...
class Nodo {
	 ...
	 * conexiones, su padre estara indefinido al igual que su distancia conexiones.length)
	 * @constructor
	 * @param {Array} valor arreglo que indica las coordenadas de la celda -> [x, y]
	 */
	constructor(valor) {
		this.valor = valor;
		this.conexiones = [];
	...
	/**
	 *
	 * @param {Nodo} vecino es un elemento del grafo de la clase Arbol
	 * @see Arbol
	 */
	conectar(vecino) {
